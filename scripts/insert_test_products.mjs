...
async function createTables() {
  ...
  try {
    ...
    const { error: translationsError } = await supabase.query(`
    ...
    if (translationsError) {
      console.error('Error creating product_translations table:', translationsError);
    } else {
      console.log('Product translations table created or already exists');
    }
    
    // Create product_categories junction table
    const { error: categoriesJunctionError } = await supabase.query(`
    ...
    if (categoriesJunctionError) {
      console.error('Error creating product_categories table:', categoriesJunctionError);
    } else {
