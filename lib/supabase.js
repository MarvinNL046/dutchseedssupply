...
export async function getDomainId() {
  ...
  console.log('getDomainId cookie:', cookie);
  return cookie?.value || 'nl'; // Default to 'nl' instead of 'com'
}
...
export async function getLocale() {
  ...
  console.log('getLocale cookie:', cookie);
  return cookie?.value || 'nl'; // Default to 'nl' instead of 'en'
}
