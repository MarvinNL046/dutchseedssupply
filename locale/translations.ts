...
const translations: Translations = {
  en: {
    ...
    customersFavorites: 'Customers\' Favorites',
    growingTips: 'Growing Tips',
    indoorGrowing: 'Indoor Growing',
    outdoorGrowing: 'Outdoor Growing',
    ...
    checkAvailability: 'Check availability in your region',
  ...
  nl: {
    ...
    thcContent: 'THC Gehalte',
    cbdContent: 'CBD Gehalte',
    yieldAmount: 'Opbrengst',
    relatedProducts: 'Gerelateerde Producten',
    similarProducts: 'Vergelijkbare Producten',
    customersFavorites: 'Favorieten van Klanten',
    growingTips: 'Kweektips',
    indoorGrowing: 'Binnen Kweken',
    outdoorGrowing: 'Buiten Kweken',
    idealConditions: 'Ideale Omstandigheden',
    effects: 'Effecten',
    flavors: 'Smaken',
    discount: 'Korting',
    highTHC: 'Hoog THC',
    viewOtherProducts: 'Bekijk andere producten',
    checkAvailability: 'Controleer beschikbaarheid in jouw regio',
  ...
  de: {
    ...
    thcContent: 'THC Gehalt',
    cbdContent: 'CBD Gehalt',
    yieldAmount: 'Ertrag',
    relatedProducts: 'Ähnliche Produkte',
    similarProducts: 'Vergleichbare Produkte',
    customersFavorites: 'Kundenlieblings',
    growingTips: 'Anbautipps',
    indoorGrowing: 'Indoor-Anbau',
    outdoorGrowing: 'Outdoor-Anbau',
    idealConditions: 'Ideale Bedingungen',
    effects: 'Wirkungen',
    flavors: 'Geschmacksrichtungen',
    discount: 'Rabatt',
    highTHC: 'Hoher THC',
    viewOtherProducts: 'Andere Produkte ansehen',
    checkAvailability: 'Verfügbarkeit in Ihrer Region prüfen',
  ...
  fr: {
    ...
    thcContent: 'Teneur en THC',
    cbdContent: 'Teneur en CBD',
    yieldAmount: 'Rendement',
    relatedProducts: 'Produits Associés',
    similarProducts: 'Produits Similaires',
    customersFavorites: 'Favoris des Clients',
    growingTips: 'Conseils de Culture',
    indoorGrowing: 'Culture en Intérieur',
    outdoorGrowing: 'Culture en Extérieur',
    idealConditions: 'Conditions Idéales',
    effects: 'Effets',
    flavors: 'Saveurs',
    discount: 'Réduction',
    highTHC: 'THC Élevé',
    viewOtherProducts: 'Voir d\'autres produits',
    checkAvailability: 'Vérifier la disponibilité dans votre région',
